...
import mc.rellox.spawnerlegacyapi.text.content.type.*;
...
public interface IContent {
    ...
    /**
     * @param pairs placeholder and value pairs
     * @return Content with variables
     */

    default IContent modified(Object... pairs) {
        return modified(IVariables.with(pairs));
    }
