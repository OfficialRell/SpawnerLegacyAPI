...
public class IVersion1_21_6 implements IVersion {
	...
	public Object spawn(Object entity) {
		...
		Object m = RF.build(a, _entity, int.class, c).instance(entity, 0, d);
	...
	private static final Invoker<?> _datawatcher = RF.order(_entity, "aC");
	private static final Invoker<?> _datawatcher_items = RF.order(_datawatcher.returns(), "c");
	private static final Construct<?> _metadata = RF.build("net.minecraft.network.protocol.game.PacketPlayOutEntityMetadata",
