...
public enum SpawnerType {
	...
	CAMEL_HUSK(_e("CAMEL_HUSK"), "Camel Husk", _m("CAMEL_HUSK_SPAWN_EGG"), EntityBox.box(2, 3, 2)),
	...
	MAGMA_CUBE(EntityType.MAGMA_CUBE, "Magma Cube", Material.MAGMA_CUBE_SPAWN_EGG, SLAPI.spawners().magmaBox()),
	...
	PARCHED(_e("PARCHED"), "Parched", _m("PARCHED_SPAWN_EGG"), EntityBox.doubled),
	...
	SLIME(EntityType.SLIME, "Slime", Material.SLIME_SPAWN_EGG, SLAPI.spawners().slimeBox()),
